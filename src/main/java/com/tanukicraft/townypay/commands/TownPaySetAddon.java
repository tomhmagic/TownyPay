                    ...
                    if (GeneralUtil.isNotInteger(strings[0])){
                        ...
                        if (!(value >= min && value <= max)) {
                            ...
                            if (town != null) {
                                ...
                                MessageUtil.sendMsg(commandSender,Translatable.of("townypay.town.PaySet", value));
                            }
                        }
                    }
                } else { //syntax error
                    MessageUtil.sendErrorMsg(commandSender, Translatable.of("townypay.town.CommandFail.set"));
                    return false;
                }
            } else { //no perms
